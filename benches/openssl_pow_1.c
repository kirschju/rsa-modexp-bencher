...
// BENCH_FUNC BN_mod_exp_mont_consttime_x2
//
#ifndef BENCH_FUNC
...
{
    BIGNUM *X_their, *X_our, *X_our_2, *g, *a, *N;
    BN_CTX *ctx;
    ...
    if (BENCH_FUNC(X_our, g, a, N, mont_ctx,
                   X_our_2, g, a, N, mont_ctx,
                   ctx) == 0) {
    ...
    *rounds = 0;
    ...
    while (!test_done) {
        BENCH_FUNC(X_our, g, a, N, mont_ctx,
                   X_our_2, g, a, N, mont_ctx,
                   ctx);
        *rounds += 2;
    }
