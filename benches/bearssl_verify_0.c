...
// BENCH_FUNC br_rsa_i15_public
// BENCH_FUNC br_rsa_i31_public
// BENCH_FUNC br_rsa_i32_public
// BENCH_FUNC br_rsa_i62_public
//
#ifndef BENCH_FUNC
...
int bench(unsigned long long *rounds)
{
    ...
    if (br_rsa_i62_private(msg, &skey) != 1) {
        return BENCH_ERR_SIGN_FAILED;
    }

    if (BENCH_FUNC(msg, sizeof(msg), &pkey) != 1) {
    ...
    *rounds = 0;
    ...
    while (!test_done) {
        BENCH_FUNC(msg, sizeof(msg), &pkey);
        *rounds += 1;
    }
